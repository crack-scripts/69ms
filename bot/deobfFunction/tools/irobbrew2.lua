--[[
69ms — Ironbrew v2 / ib2 deobfuscator runner
========================================
INPUT  = first CLI arg (source file path)
OUTPUT = second CLI arg (write decoded result here)

Wire your open-source ib2 deobfuscator between the
...
-- ============================================================
-- BEGIN USER DEOBF — paste your Ironbrew v2 deobfuscator Lua below
-- ============================================================
...
print("[69ms] Irobbrew2 deobfuscation complete")
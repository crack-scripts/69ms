--[[
69ms — Moonsec deobfuscator runner
===============================
INPUT  = first CLI arg (source file path)
OUTPUT = second CLI arg (write decoded result here)

Wire your open-source Moonsec deobfuscator between the
...
-- ============================================================
-- BEGIN USER DEOBF — paste your Moonsec deobfuscator Lua below
-- ============================================================
...
print("[69ms] Moonsec deobfuscation complete")
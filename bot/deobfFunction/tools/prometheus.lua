--[[
69ms — Prometheus / LuaObfuscator deobfuscator runner
=================================================
INPUT  = first CLI arg (source file path)
OUTPUT = second CLI arg (write decoded result here)

Wire your open-source Prometheus deobfuscator between the
...
-- ============================================================
-- BEGIN USER DEOBF — paste your Prometheus deobfuscator Lua below
-- ============================================================
...
print("[69ms] Prometheus deobfuscation complete")
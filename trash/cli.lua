...
local function script_path()
	...
	-- Fall back to "./" when the script was invoked without a path separator
	-- (e.g. `lua cli.lua`), otherwise the match is nil and the following
	-- concatenation throws "attempt to concatenate a nil value".
	return str:match("(.*[/%\\])") or "./"
end
